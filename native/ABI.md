...
| `ex.term.make_fun_with_signature` | `(fn_idx: i64, arity: i64, result_mode: i64, env_len: i64, e0..e3: i64) -> i64` | signature-carrying closure; result mode 0 is scalar and 1 is a tagged term word |
...
| `ex.term.fun_result_mode` | `(fun: i64) -> i64` | closure result mode (0 scalar / 1 term); -1 when unavailable |
