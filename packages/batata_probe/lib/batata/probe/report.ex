defmodule Batata.Probe.Report do
  @moduledoc """
  Builds a deterministic, machine-readable frontend probe report.
  ...
  @doc "Builds a report for an Elixir project or `lib` directory."
  ...
  defp corpus(metadata, files) do
    %{
      "name" => Map.get(metadata, "name", "corpus"),
