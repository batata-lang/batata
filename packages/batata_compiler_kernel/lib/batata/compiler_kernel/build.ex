defmodule Batata.CompilerKernel.Build do
  ...
  @compiler_abi_calls [
                        ...
                        {:operation_region_count, [], :count},
                        {:single_region_block, [:index], :block},
                        {:block_argument_count, [:block], :count},
                        {:block_argument, [:block, :index], :value},
                        {:block_terminator, [:block], :operation},
                        {:operation_operand_count, [:operation], :count},
                        {:operation_result_count, [:operation], :count},
                        {:operation_operand, [:operation, :index], :value},
                        {:function_type_reset, [], :status},
                        {:function_type_add_input, [:type], :status},
                        {:function_type_add_result, [:type], :status},
                        {:function_type_create, [], :type},
