defmodule BatataDecimal.MixProject do
  use Mix.Project
  ...
  def project do
    [
      ...
      deps: deps(),
      name: "Batata Decimal",
      description: "Fail-closed Decimal compatibility evidence for Batata",
      docs: docs(),
      package: package()
    ]
  end
  ...
  defp package do
    [
      ...
      links: %{
        ...
        "Decimal upstream" => "https://github.com/ericmj/decimal"
      },
