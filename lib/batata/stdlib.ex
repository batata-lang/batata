defmodule Batata.Stdlib.Kernel do
  ...
  @class_map %{
    ...
    {:erlang, :integer_to_list, 1} => :native_term,
    {:erlang, :list_to_integer, 1} => :native_term,
    {:erlang, :binary_to_float, 1} => :native_term,
    {:erlang, :float_to_binary, 2} => :native_term,
...
defmodule Batata.Stdlib.List do
  ...
  @class_map %{
    ...
    {List, :insert_at, 3} => :native_term,
    {List, :to_integer, 1} => :native_term,
